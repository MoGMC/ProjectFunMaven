			...
			if (sender instanceof Player) {
				...
				if (!player.hasPermission(getPerm())) {					
					...
					if(PF.lickCool.containsKey(sender.getName())) {
						...
						if (target != null) {
							Bukkit.broadcastMessage(ChatColor.LIGHT_PURPLE + p + ChatColor.RED + " L" + ChatColor.LIGHT_PURPLE + "I" + ChatColor.GOLD + "C" + ChatColor.BLUE + "K" + ChatColor.YELLOW + "E" + ChatColor.WHITE + "D " + ChatColor.LIGHT_PURPLE + target.getName() + ChatColor.DARK_RED + "!");
						} else if(args[0].equalsIgnoreCase("all")) {
							Bukkit.broadcastMessage(ChatColor.LIGHT_PURPLE + p + ChatColor.RED + " L" + ChatColor.LIGHT_PURPLE + "I" + ChatColor.GOLD + "C" + ChatColor.BLUE + "K" + ChatColor.YELLOW + "E" + ChatColor.WHITE + "D " + ChatColor.LIGHT_PURPLE + "EVERYONE" + ChatColor.DARK_RED + "!");
					} else {
