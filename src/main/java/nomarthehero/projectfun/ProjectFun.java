...
public class ProjectFun extends JavaPlugin implements Listener {
	...
	/*TODO:
	 * hashtags command, list of hashtags
	 * if statement on funcommand using permissions
	 * seperate class for all messages, perhaps config?
	 */
	...
	public void onEnable() {		
        ...
        Bukkit.broadcastMessage(new FancyMessage("DEBUG").formattedTooltip(new FancyMessage("DEBUG2")).toJSONString());
